...
<div class="container disable">
	<h2>나만의 여행 다이어리</h2>
	<div class="wrapper">
		<form method="post" action="addDiary" enctype="multipart/form-data" id="diaryUpload">
			<input type="hidden" value="${sessionScope.sessionID }" name="dwriter" id="dwriter"> 
			<label for="dtitle">제목</label> 
			<input type="text" id="dtitle" name="dtitle" required="required">
			...
			<div>
				...
				<textarea name="dcontent" id="dcontent" required="required"></textarea>

				<label for="dtag">해시태그</label> <input type="text" id="dtag" name="dtag" required="required">
			</div>
